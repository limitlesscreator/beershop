    ...
    return (
        <div className={s.main}>
            ...
            <Routes>
                ...
                <Route path={'beerDetails/:beer'} element={<Beerdetails setLongFetchingError={props.setLongFetchingError} longFetchingError={props.longFetchingError} userLogged={props.userLogged} fetchBeers={props.fetchBeers} setConstBasket={props.setConstBasket} setSizeBasket={props.setSizeBasket}   setValueOfStuff={props.setValueOfStuff} valueOfStuff={props.valueOfStuff} setReloadData={props.setReloadData} priceOfBeer={props.priceOfBeer} reloadData={props.reloadData} beerDetails={props.beerDetails} currentBeer={props.currentBeer}/>}/>
